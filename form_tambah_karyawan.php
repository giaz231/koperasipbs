...
<?php
session_start();
$halaman_active = 'form_tambah_karyawan';
include 'session.php';
    ...
    <body>
                ...
                <div id="sidebar">
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-header sidebar-nav-mini-hide" style="margin-top:<?php if(empty($_SESSION['islogin'])){echo '240px';} else {echo '60px';}  ?>">
                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        ...
                        <ul class="breadcrumb breadcrumb-top">
                            <li>Forms </li>
                            <li><a href="">Input Data Pegawai</a></li>
                        </ul>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Form </strong>Input Data Pegawai</h2>
                                    </div>
                                    <!-- END Form Elements Title -->

                                    <!-- Basic Form Elements Content -->
                                    <form  method="post" enctype="multipart/form-data" id="input_pegawai" class="form-horizontal form-bordered" >
                                        <input type="hidden" name="page" value="addpegawai">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nama Anda</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="nama" class="form-control" placeholder="Text">
                                                <span class="help-block">*Pastikan Data Sudah Sesuai Data Yang Berlaku</span>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Iuran Wajib</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="iuran_wajib" class="form-control" placeholder="Numbers" maxlength="13">
                                                <span class="help-block">Mohon untuk memasukkan angka</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Investasi</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="investasi" class="form-control" placeholder="Numbers" maxlength="13">
                                                <span class="help-block">Mohon untuk memasukkan angka</span>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            function growlsuccess() {
                $.bootstrapGrowl('<h4>Add Pegawai Success !</h4> <p>Pegawai has been added successfully !</p>', {
                            type: 'success',
                            delay: 2800,
                            allow_dismiss: true
                        });
            ...
            $(function(){
                ...
                $('#input_pegawai').on('submit', function(){
                    event.preventDefault();
                    $.ajax({
                        url:"control.php",  
                        method:"POST",  
                        data:$('#input_pegawai').serialize(), 
                        dataType:'html',   
                        success:function(data){
                        $("#input_pegawai")[0].reset();
                        growlsuccess();
                        }  
                    });
                });
