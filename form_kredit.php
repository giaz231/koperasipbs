    ...
    <body>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Form</strong> Kredit</h2>
                                    </div>
                                    <!-- END Form Elements Title -->

                                    <!-- Basic Form Elements Content -->
                                    <form id="form_kredit" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" >
                                        <input type="hidden" name="page" value="addkredittransaksi">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Jumlah Kredit</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="kredit" class="form-control" placeholder="Numbers" maxlength="13">
        ...
        <script>
            ...
            function growlsuccess() {
                $.bootstrapGrowl('<h4>Add Kredit Transaction Success !</h4> <p>Kredit Transaction has been added successfully !</p>', {
                            type: 'success',
                            delay: 3200,
                            allow_dismiss: true
                        });
            ...
            $(function(){
                ...
                $('#form_kredit').on('submit', function(){
                    event.preventDefault();
                    $.ajax({
                        url:"control.php",  
                        method:"POST",  
                        data:$('#form_kredit').serialize(), 
                        dataType:'html',   
