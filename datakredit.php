                    ...
                    <div id="page-content">
                        ...
                        <div class="block full">
                            <div class="block-title">
                                <h2><strong>Koperasi Pandu Bahtera Sejahtera Kredit Report</strong></h2>
                            </div>
                            <p></p>
                            <div class="table-responsive">
                                ...
                                <tbody id="list-data-kredit">
                                    <?php include 'datatableskredit.php'; ?>
                                </tbody>
                                </table>
                            </div>
                        </div>
        ...
        <script>
            ...
            $(function(){
             ...
             $('#example-datatable tbody').on('click', 'button#btn-delete', function () {
                    var idtranskredit = $(this).data("idtranskredit");
                    var page = $(this).data("pages");
                    var nama_pegawai = $(this).data("nama_pegawai");
                    var table = $('#example-datatable').DataTable();
                    if (confirm('Apakah And Yakin Ingin Menghapus Transaksi Kredit Atas Nama Pegawai ini '+nama_pegawai+' ?')) {
                        
                        $.ajax({
                            url:"control.php",
                            method:"POST",
                            data:{idtranskredit:idtranskredit,page:page},
